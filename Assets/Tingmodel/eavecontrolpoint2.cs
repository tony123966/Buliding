...
public class eavecontrolpoint2 : MonoBehaviour {
    ...
    void OnMouseUp()
    {
        ...
        this.transform.parent.parent.GetComponent<EaveControl>().r2p = this.transform.position;
        this.transform.parent.parent.GetComponent<EaveControl>().r3p = this.transform.parent.GetChild(2).position;
