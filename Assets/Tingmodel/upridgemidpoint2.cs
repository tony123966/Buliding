...
public class upridgemidpoint2 : MonoBehaviour
{
    ...
    void OnMouseDrag()
    {
        ...
        Vector3 vector = Quaternion.AngleAxis(0, Vector3.up) * (transform.parent.GetChild(0).transform.position - transform.position);
        Vector3 vector2 = Quaternion.AngleAxis(-90, Vector3.up) * (transform.parent.GetChild(0).transform.position - transform.position);
        ...
        {//鼠标按着左键移动
            ...
            transform.parent.parent.GetChild(3).Translate(y * -vector.x, 0, y * -vector.z);

            transform.parent.parent.parent.GetChild(0).GetChild(0).GetChild(1).Translate(y * -vector.x, 0, y * -vector.z);
            transform.parent.parent.parent.GetChild(0).GetChild(0).GetChild(2).Translate(y * -vector2.x, 0, y * -vector2.z);
            transform.parent.parent.parent.GetChild(0).GetChild(0).GetChild(3).Translate(y * -vector.x, 0, y * -vector.z);
            transform.parent.parent.parent.GetChild(0).GetChild(0).GetChild(0).Translate(y * -vector2.x, 0, y * -vector2.z);


            transform.parent.parent.parent.GetChild(5).GetChild(1).Translate(y * -vector.x, 0, y * -vector.z);
            //transform.parent.parent.parent.GetChild(5).GetChild(1).Translate(y * -vector2.x, 0, y * -vector2.z);
            transform.parent.parent.parent.GetChild(5).GetChild(3).Translate(y * -vector.x, 0, y * -vector.z);
            //transform.parent.parent.parent.GetChild(5).GetChild(3).Translate(y * -vector2.x, 0, y * -vector2.z);

            transform.parent.parent.parent.GetChild(2).GetChild(1).Translate(y * -vector.x, 0, y * -vector.z);

            transform.parent.parent.parent.GetChild(2).GetChild(3).Translate(y * -vector.x, 0, y * -vector.z);

            transform.parent.parent.parent.GetChild(3).GetChild(1).Translate(y * -vector.x, 0, y * -vector.z);

            transform.parent.parent.parent.GetChild(3).GetChild(3).Translate(y * -vector.x, 0, y * -vector.z);


            transform.parent.parent.parent.GetChild(4).GetChild(1).Translate(y * -vector.x, 0, y * -vector.z);

            transform.parent.parent.parent.GetChild(4).GetChild(3).Translate(y * -vector.x, 0, y * -vector.z);
    ...
    void OnMouseUp()
    {
        ...
        up.inig3(transform.parent.parent.GetChild(2).transform.gameObject);
        up.inig4(transform.parent.parent.GetChild(0).transform.gameObject);
