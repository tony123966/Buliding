...
public class Friezemesh : MonoBehaviour {
	...
	void Update () {
        ...
        if (i != angle)
        {
            Vector3 V1 = GameObject.Find("column" + i).transform.GetChild(0).position;
            Vector3 V2 = GameObject.Find("column" + (i + 1)).transform.GetChild(0).position;
            Vector3 V3 = GameObject.Find("column" + i).transform.GetChild(1).position;
            Vector3 V4 = GameObject.Find("column" + (i + 1)).transform.GetChild(1).position;
        ...
        {
            Vector3 V1 = GameObject.Find("column" + i).transform.GetChild(0).position;
            Vector3 V2 = GameObject.Find("column1").transform.GetChild(0).position;
            Vector3 V3 = GameObject.Find("column" + i).transform.GetChild(1).position;
            Vector3 V4 = GameObject.Find("column1").transform.GetChild(1).position;
