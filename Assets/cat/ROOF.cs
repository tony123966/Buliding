...
public class ROOF : MonoBehaviour
{
    ...
    public delegate GameObject OnGetCloneEvent(ROOF sender, GameObject source);
    public delegate void OnReleaseCloneEvent(ROOF sender, GameObject clone);
    /// <summary>
    ...
    /// </summary>
    public static ROOF Create()
    {
        ROOF o = new GameObject("CurvyClonePath", typeof(ROOF)).GetComponent<ROOF>();
        return o;
    }
