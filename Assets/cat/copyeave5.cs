...
public class copyeave5 : MonoBehaviour {
	...
	void Update () {
        ...
        if (vectormove.movenum == ("CP003") && gameObject.transform.parent.name.Substring(0, 3) == ("eav") || vectormove.movenum == ("CP003") && gameObject.transform.parent.name.Substring(0, 3) == ("roo"))
        {
